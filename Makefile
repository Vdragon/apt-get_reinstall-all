...
name_project = apt-get_reinstall-all
...
.PHONY : uninstall
uninstall : 
	${COMMAND_REMOVE_LINUX} ${dir_install_prefix}/sbin/apt-get_reinstall-all
	${COMMAND_REMOVE_LINUX} ${dir_install_prefix}/sbin/apt-get_reinstall-all_installAndCleanPackages
